...
const Features = () => {
  ...
  return (
    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div
            className="grid max-w-4xl lg:max-w-6xl grid-cols-1 mx-auto mt-8 text-center gap-y-4 sm:gap-x-8 sm:grid-cols-2 lg:grid-cols-3 sm:mt-12 lg:mt-20 sm:text-left " data-aos='fade-up' >
            <div className="relative" >
                <div className="absolute -inset-1">
                    
                </div>
                <div className="relative overflow-hidden bg-white shadow-md rounded-xl h-full hover:scale-105 transition-transform  transfrom-ease-in-out hover:shadow-xl">
            ...
            <div className="relative">
                ...
                <div className="relative overflow-hidden bg-white shadow-md rounded-xl h-full hover:scale-105 transition-transform  transfrom-ease-in-out hover:shadow-xl" data-aos='fade-up'>
                    <div className="p-9"><svg className="w-12 h-12 mx-auto text-gray-400 sm:mx-0" viewBox="0 0 24 24"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M11 8L20 8" stroke="#111827" stroke-width="2" stroke-linecap="round"></path>
                            <path d="M4 16L14 16" stroke="#111827" stroke-width="2" stroke-linecap="round"></path>
