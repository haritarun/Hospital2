            ...
            <div className="py-7 border-t border-gray-200">
                <div className="flex items-center justify-center flex-col sm:justify-between sm:flex-row">
                    ...
                    <div className="flex mt-6 space-x-4 sm:justify-center sm:mt-0 ">
                        ...
                        <a href="javascript:;"
                            className="group w-9 h-9 transition-all duration-500 rounded-full border border-gray-300 flex justify-center items-center hover:border-indigo-600">
                            <svg className="w-[1.25rem] h-[1.125rem] transition-all duration-500 text-gray-700 group-hover:text-indigo-600"
                        ...
                        <a href="javascript:;"
                            className="group w-9 h-9 transition-all duration-500 rounded-full border border-gray-300 flex justify-center items-center hover:border-indigo-600">
                            <svg className="w-[1rem] h-[1rem] transition-all duration-500 text-gray-700 group-hover:text-indigo-600"
                        ...
                        <a href="javascript:;"
                            className="group w-9 h-9 transition-all duration-500 rounded-full border border-gray-300 flex justify-center items-center hover:border-indigo-600">
                            <svg className="w-[1.25rem] h-[0.875rem] transition-all duration-500 text-gray-700 group-hover:text-indigo-600"
