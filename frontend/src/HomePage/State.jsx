...
const State = () => {
  ...
  return (
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl md:text-center" data-aos="fade-up">
        ...
        <ul role="list"
            className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-6 sm:gap-8 lg:mt-20 lg:max-w-none lg:grid-cols-3" data-aos="fade-up">
            <li>
                <ul role="list" className="flex flex-col gap-y-6 sm:gap-y-8 hover:scale-105 hover:transition-transform duration-700" >
                    <li>
